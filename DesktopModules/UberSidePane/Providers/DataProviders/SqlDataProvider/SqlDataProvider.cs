...
namespace Uberistic.Modules.UberSidePane.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "UberSidePane_";
        ...
        public IDataReader GetBusinessProfileByUBPID(int UBPID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "Uber_GetBusinessLogoFromBusinessProfile", UBPID);
        }
