...
namespace DotNetNuke.Modules.UberFirstStartBusiness
{
    ...
    /// are accessible to your module's controls (that inherity from UberFirstStartBusinessSettingsBase
    /// 
    /// </summary>


    public class UberFirstStartBusinessSettingsBase : ModuleSettingsBase
    {
