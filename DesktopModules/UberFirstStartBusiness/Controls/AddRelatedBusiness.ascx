<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddRelatedBusiness.ascx.cs" Inherits="DotNetNuke.Modules.UberFirstStartBusiness.Controls.AddRelatedBusiness" %>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanelLogo" runat="server">
                    <ContentTemplate>
                        <asp:FileUpload ID="FileUploadBusinessLogo" ViewStateMode="Enabled" runat="server" Width="399px" />
                    </ContentTemplate>
                    <Triggers>
