...
namespace DotNetNuke.Modules.UberFirstStartBusiness
{
    ...
    /// are accessible to your module's controls (that inherity from UberFirstStartBusinessModuleBase
    /// 
    /// </summary>

    public class UberFirstStartBusinessModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
